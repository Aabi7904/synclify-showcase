...
// --- 3D Component: The Central "Mixing" Animation ---
    ...
    <Canvas className="h-[400px] w-full" camera={{ position: [0, 0, 4] }}>
      ...
      <Float speed={4} rotationIntensity={1} floatIntensity={2}>
        <Sphere args={[1, 100, 100]} scale={1.8}>
          <MeshDistortMaterial
            color="#f59e0b" // Amber/Gold to match the "Cooking" theme
            attach="material"
            distort={0.4}
            speed={2}
            roughness={0.2}
...
const Index = () => {
  ...
  const handleNotify = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "We'll notify you the moment our new site goes live.",
    });
    setEmail("");
  };
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8 animate-fade-in z-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 text-amber-600 border border-amber-500/20 mb-4">
              ...
              <span className="text-sm font-semibold">Grand Revamp</span>
            </div>

            <h1 className="text-5xl md:text-7xl font-bold leading-tight">
              The <span className="gradient-text text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-orange-600">Main Course</span> <br />
              is Coming Soon.
            </h1>

            <p className="text-xl text-muted-foreground max-w-lg mx-auto lg:mx-0">
              We are redesigning our entire digital experience from thought to technology. Our developers are cooking up something extraordinary.
            </p>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-3 text-sm text-muted-foreground pt-4">
              ...
              <span>Status: Heating up the servers</span>
            </div>
          </div>
